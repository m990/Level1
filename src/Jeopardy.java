...
public class Jeopardy implements ActionListener {
	...
	private JButton fifthButton, sixthButton, seventhButton;
	...
	private void start() {
		...
		JPanel header = createHeader("This is a header.");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton){
			...
			askQuestion("green", "What's my favroite color?", 100);
			firstButton.setText("");
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("callie and oreo", "Who are my dogs?", 200);
		// Clear the button text (set the button text to nothing)
			secondButton.setText("");
		}
		else if (buttonPressed == thirdButton){
			askQuestion("Jude", "Who is my guitar teacher?", 300);
			thirdButton.setText("");
		}
		else if (buttonPressed == fourthButton){
			askQuestion("iPad air", "What kind of iPad do I have?", 400);
			fourthButton.setText("");
		}
		else if (buttonPressed == fifthButton){
			askQuestion("the names of my fish", "They don't have names.", 500);
			fifthButton.setText("");
		}
